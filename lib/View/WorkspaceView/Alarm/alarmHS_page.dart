...
class AlarmHSPage extends StatefulWidget {
  final int? itemId;

  const AlarmHSPage({super.key, this.itemId});

  @override
  State<AlarmHSPage> createState() => _AlarmHSPageState();
}

class _AlarmHSPageState extends State<AlarmHSPage> {
  ...
  getAlarmHistoryList() async {
    ...
    print(params);
    var data = await AlarmDao.getAlarmHistoryList(params: params);
    if (data["code"] == 200) {
      if (data['data'] != null) {
                      ...
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: TextButton(
                              style: TextButton.styleFrom(
                                backgroundColor: Color(0xFFF2F8F9),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextButton(
                              style: TextButton.styleFrom(
                                backgroundColor: Color(0xFF24C18F),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(10),
                                ),
                              ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    //     style: const TextStyle(
                    //         fontSize: 12,
                    //         color: Color.fromARGB(255, 38, 246, 45)),
                    //   ),
                    // ),
                  ],
                ),
                ...
                Row(
                  children: [
                    Text('${S.current.first_occurrence_time}：',
                        style: const TextStyle(
                            color: Color.fromRGBO(14, 15, 16, 1),
                            fontSize: 14)),
                    Text('${data['alarmTime']}',
                        style: const TextStyle(
