...
class OplWorkspacePage extends StatefulWidget {
  const OplWorkspacePage({super.key});

  @override
  State<OplWorkspacePage> createState() => _OplWorkspacePageState();
}

class _OplWorkspacePageState extends State<OplWorkspacePage> {
  List operationList = [
    S.current.work_order_management,
    S.current.inspection_task,
    S.current.shift_plan,
    S.current.event_record,
    S.current.data_analysis
  ];
